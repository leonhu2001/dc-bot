...
from services.ticket_transcripts import ensure_ticket_transcript_tables
...
from web.app.routers.ticket_transcripts import router as ticket_transcripts_router
...
app.include_router(ticket_transcripts_router)
